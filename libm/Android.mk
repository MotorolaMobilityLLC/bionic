...
ifeq (yes,$(MTK_POW_OPT))
 ...
 ifneq (, $(filter $(TARGET_ARCH), arm64 arm))
  ifneq (, $(wildcard $(LOCAL_PATH)/$(TARGET_ARCH)/$(TARGET_CPU_VARIANT)/$(TARGET_CPU_VARIANT).mk))
   ...
   LOCAL_SRC_FILES_$(TARGET_ARCH) += $(libm_c_src_files_arm_generic) $(libm_c_src_files_generic)
  endif
 else
  LOCAL_SRC_FILES_$(TARGET_ARCH) += $(libm_c_src_files_arm_generic) $(libm_c_src_files_generic)
 ...
 ifdef TARGET_2ND_ARCH
  ifeq ($(TARGET_2ND_ARCH), arm)
   ifneq (, $(wildcard $(LOCAL_PATH)/$(TARGET_2ND_ARCH)/$(TARGET_2ND_CPU_VARIANT)/$(TARGET_2ND_CPU_VARIANT).mk))
    ...
    LOCAL_SRC_FILES_$(TARGET_2ND_ARCH) += $(libm_c_src_files_arm_generic) $(libm_c_src_files_generic)
   endif
  endif # ifeq ($(TARGET_2ND_ARCH), arm)
 endif # ifdef TARGET_2ND_ARCH

else
 LOCAL_SRC_FILES_arm += $(libm_c_src_files_arm_generic)
 LOCAL_SRC_FILES_arm64 += $(libm_c_src_files_arm_generic)
 LOCAL_SRC_FILES += $(libm_c_src_files_generic)
